...
public class SubcategoryService extends AbstractService<SubcategoryDto, String, Subcategory>{
    ...
    @Override
    public Pager<SubcategoryDto> loadAll(int currentPage, int noOfRowInPage) {
        Page<Subcategory> subcategories = getSubcategoryRepository().findAll(Paginator.getValidPageRequest(currentPage, noOfRowInPage, new Sort(Sort.Direction.ASC, "category")));
